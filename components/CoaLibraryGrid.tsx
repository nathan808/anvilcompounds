...
function CoaCard({
  ...
  return (
    <div
      className={`group glass-card rounded-xl p-6 flex flex-col justify-between transition-all duration-200 ${
        hasCoa ? "hover:border-blue-500/40 hover:-translate-y-0.5" : ""
      }`}
    >
      <div>
      ...
      <div className="mt-6">
        {hasCoa ? (
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 group-hover:bg-blue-500 text-white font-display font-700 text-sm transition-all duration-200"
          >
          ...
          <span className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white/30 font-display font-700 text-sm opacity-40 cursor-not-allowed">
            COA Pending
          </span>
        )}
      </div>
